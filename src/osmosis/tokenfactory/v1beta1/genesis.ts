...
import { DenomAuthorityMetadata, type DenomAuthorityMetadataAmino } from "./authority_metadata"
import { Params, type ParamsAmino } from "./params"
...
export const GenesisDenom = {
	...
	toAmino(message: GenesisDenom): GenesisDenomAmino {
		...
		obj.authority_metadata = message.authorityMetadata
			...
			: DenomAuthorityMetadata.toAmino(DenomAuthorityMetadata.fromPartial({}))
		return obj
	},
