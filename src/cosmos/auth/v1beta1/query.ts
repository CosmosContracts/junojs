...
import {
	BaseAccount,
	type BaseAccountAmino,
	type BaseAccountProtoMsg,
	ModuleAccount,
	type ModuleAccountProtoMsg,
	Params,
	type ParamsAmino
} from "./auth"
/**
 ...
 * Since: cosmos-sdk 0.46
 */
export type QueryModuleAccountsRequestAmino = {}
 ...
 * Since: cosmos-sdk 0.46
 */
export type Bech32PrefixRequestAmino = {}
...
export const QueryModuleAccountsResponse = {
	...
	fromAmino(object: QueryModuleAccountsResponseAmino): QueryModuleAccountsResponse {
		const message = createBaseQueryModuleAccountsResponse()
		message.accounts =
			object.accounts?.map((e) => Cosmos_authv1beta1ModuleAccountI_FromAmino(e)) || []
		return message
	},
...
export const QueryAccountAddressByIDRequest = {
	...
	fromPartial(object: Partial<QueryAccountAddressByIDRequest>): QueryAccountAddressByIDRequest {
		const message = createBaseQueryAccountAddressByIDRequest()
		message.id =
			object.id !== undefined && object.id !== null ? BigInt(object.id.toString()) : BigInt(0)
		message.accountId =
