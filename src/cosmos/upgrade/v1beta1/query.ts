...
import { ModuleVersion, type ModuleVersionAmino, Plan, type PlanAmino } from "./upgrade"
/**
 ...
 * method.
 */
export type QueryCurrentPlanRequestAmino = {}
 ...
 * Since: cosmos-sdk 0.46
 */
export type QueryAuthorityRequestAmino = {}
...
export const QueryUpgradedConsensusStateRequest = {
	...
	toAmino(message: QueryUpgradedConsensusStateRequest): QueryUpgradedConsensusStateRequestAmino {
		const obj: any = {}
		obj.last_height =
			message.lastHeight !== BigInt(0) ? message.lastHeight?.toString() : undefined
		return obj
	},
	fromAminoMsg(
