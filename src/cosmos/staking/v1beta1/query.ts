...
import {
	DelegationResponse,
	type DelegationResponseAmino,
	HistoricalInfo,
	type HistoricalInfoAmino,
	Params,
	type ParamsAmino,
	Pool,
	type PoolAmino,
	RedelegationResponse,
	type RedelegationResponseAmino,
	UnbondingDelegation,
	type UnbondingDelegationAmino,
	Validator,
	type ValidatorAmino
} from "./staking"
...
/** QueryPoolRequest is request type for the Query/Pool RPC method. */
export type QueryPoolRequestAmino = {}
...
export const QueryValidatorRequest = {
	...
	encode(
		...
		if (message.validatorAddr && message.validatorAddr !== "") {
...
export const QueryDelegationRequest = {
	...
	encode(
		...
		if (message.delegatorAddr && message.delegatorAddr !== "") {
...
export const QueryRedelegationsRequest = {
	...
	encode(
		...
		if (message.srcValidatorAddr && message.srcValidatorAddr !== "") {
			writer.uint32(18).string(message.srcValidatorAddr)
		}
		if (message.dstValidatorAddr && message.dstValidatorAddr !== "") {
