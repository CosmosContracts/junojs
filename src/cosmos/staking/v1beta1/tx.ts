...
import {
	CommissionRates,
	type CommissionRatesAmino,
	Description,
	type DescriptionAmino,
	Params,
	type ParamsAmino
} from "./staking"
...
/** MsgCreateValidatorResponse defines the Msg/CreateValidator response type. */
export type MsgCreateValidatorResponseAmino = {}
...
/** MsgEditValidatorResponse defines the Msg/EditValidator response type. */
export type MsgEditValidatorResponseAmino = {}
...
/** MsgDelegateResponse defines the Msg/Delegate response type. */
export type MsgDelegateResponseAmino = {}
 ...
 * Since: cosmos-sdk 0.46
 */
export type MsgCancelUnbondingDelegationResponseAmino = {}
...
export const MsgBeginRedelegate = {
	...
	toAmino(message: MsgBeginRedelegate): MsgBeginRedelegateAmino {
		...
		obj.validator_src_address =
			message.validatorSrcAddress === "" ? undefined : message.validatorSrcAddress
		obj.validator_dst_address =
			message.validatorDstAddress === "" ? undefined : message.validatorDstAddress
		obj.amount = message.amount
			? Coin.toAmino(message.amount)
			: Coin.toAmino(Coin.fromPartial({}))
		return obj
