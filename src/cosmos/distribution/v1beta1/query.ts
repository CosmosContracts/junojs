...
import {
	...
	type ValidatorAccumulatedCommissionAmino,
	ValidatorOutstandingRewards,
	type ValidatorOutstandingRewardsAmino,
	ValidatorSlashEvent,
	type ValidatorSlashEventAmino
} from "./distribution"
 ...
 * method.
 */
export type QueryCommunityPoolRequestAmino = {}
...
export const QueryValidatorSlashesRequest = {
	...
	toAmino(message: QueryValidatorSlashesRequest): QueryValidatorSlashesRequestAmino {
		...
		obj.ending_height =
			message.endingHeight !== BigInt(0) ? message.endingHeight?.toString() : undefined
