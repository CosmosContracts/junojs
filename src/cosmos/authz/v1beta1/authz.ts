...
import {
	...
	type ContractExecutionAuthorizationProtoMsg,
	ContractMigrationAuthorization,
	type ContractMigrationAuthorizationProtoMsg,
	StoreCodeAuthorization,
	type StoreCodeAuthorizationProtoMsg
...
import {
	...
	type TransferAuthorizationProtoMsg
...
export const Grant = {
	...
	decode(input: BinaryReader | Uint8Array, length?: number): Grant {
		...
		while (reader.pos < end) {
			...
			switch (tag >>> 3) {
				case 1:
					message.authorization = Cosmos_authzv1beta1Authorization_InterfaceDecoder(
						reader
					) as Any
					break
				case 2:
