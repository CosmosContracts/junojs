...
export const FileOptions = {
	...
	toAmino(message: FileOptions): FileOptionsAmino {
		...
		obj.java_multiple_files =
			message.javaMultipleFiles === false ? undefined : message.javaMultipleFiles
		...
		obj.cc_generic_services =
			message.ccGenericServices === false ? undefined : message.ccGenericServices
		obj.java_generic_services =
			message.javaGenericServices === false ? undefined : message.javaGenericServices
		obj.py_generic_services =
			message.pyGenericServices === false ? undefined : message.pyGenericServices
		obj.php_generic_services =
			message.phpGenericServices === false ? undefined : message.phpGenericServices
