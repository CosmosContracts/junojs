...
export function accessTypeToJSON(object: AccessType): string {
	switch (object) {
		...
		case AccessType.ACCESS_TYPE_ANY_OF_ADDRESSES:
			return "AccessTypeAnyOfAddresses"
		default:
			return "UNRECOGNIZED"
	}
}
...
export function contractCodeHistoryOperationTypeFromJSON(
	...
	switch (object) {
		case 0:
		case "ContractCodeHistoryOperationTypeUnspecified":
...
export function contractCodeHistoryOperationTypeToJSON(
	...
	switch (object) {
		...
		case ContractCodeHistoryOperationType.CONTRACT_CODE_HISTORY_OPERATION_TYPE_INIT:
			return "ContractCodeHistoryOperationTypeInit"
		case ContractCodeHistoryOperationType.CONTRACT_CODE_HISTORY_OPERATION_TYPE_MIGRATE:
			return "ContractCodeHistoryOperationTypeMigrate"
		case ContractCodeHistoryOperationType.CONTRACT_CODE_HISTORY_OPERATION_TYPE_GENESIS:
			return "ContractCodeHistoryOperationTypeGenesis"
		default:
			return "UNRECOGNIZED"
	}
}
		...
		while (reader.pos < end) {
			...
			switch (tag >>> 3) {
				...
				case 6:
					...
					break
				case 7:
					message.extension = Cosmwasm_wasmv1ContractInfoExtension_InterfaceDecoder(
						reader
					) as Any
					break
				default:
...
export const AbsoluteTxPosition = {
	...
	toAmino(message: AbsoluteTxPosition): AbsoluteTxPositionAmino {
		const obj: any = {}
		obj.block_height =
			message.blockHeight !== BigInt(0) ? message.blockHeight?.toString() : undefined
