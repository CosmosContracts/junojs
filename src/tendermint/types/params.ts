...
export const VersionParams = {
	...
	fromPartial(object: Partial<VersionParams>): VersionParams {
		const message = createBaseVersionParams()
		message.app =
			object.app !== undefined && object.app !== null ? BigInt(object.app.toString()) : BigInt(0)
		return message
	},
...
export const HashedParams = {
	...
	toAmino(message: HashedParams): HashedParamsAmino {
		const obj: any = {}
		obj.block_max_bytes =
			message.blockMaxBytes !== BigInt(0) ? message.blockMaxBytes?.toString() : undefined
		obj.block_max_gas =
			message.blockMaxGas !== BigInt(0) ? message.blockMaxGas?.toString() : undefined
		return obj
	},
