...
import type { BlockIDFlag } from "../types/validator"
...
export type RequestCommitAmino = {}
...
/** lists available snapshots */
export type RequestListSnapshotsAmino = {}
...
export type ResponseFlushAmino = {}
...
export const RequestInfo = {
	...
	toAmino(message: RequestInfo): RequestInfoAmino {
		...
		obj.block_version =
			message.blockVersion !== BigInt(0) ? message.blockVersion?.toString() : undefined
		obj.p2p_version =
			message.p2pVersion !== BigInt(0) ? message.p2pVersion?.toString() : undefined
...
export const RequestPrepareProposal = {
	...
	toAmino(message: RequestPrepareProposal): RequestPrepareProposalAmino {
		const obj: any = {}
		obj.max_tx_bytes =
			message.maxTxBytes !== BigInt(0) ? message.maxTxBytes?.toString() : undefined
		if (message.txs) {
...
export const ResponseInfo = {
	...
	toAmino(message: ResponseInfo): ResponseInfoAmino {
		...
		obj.version = message.version === "" ? undefined : message.version
		obj.app_version =
			message.appVersion !== BigInt(0) ? message.appVersion?.toString() : undefined
...
export const ResponseCommit = {
	...
	toAmino(message: ResponseCommit): ResponseCommitAmino {
		const obj: any = {}
		obj.retain_height =
			message.retainHeight !== BigInt(0) ? message.retainHeight?.toString() : undefined
		return obj
	},
