...
export type SnapshotsRequestAmino = {}
...
export const Message = {
	...
	toAmino(message: Message): MessageAmino {
		const obj: any = {}
		obj.snapshots_request = message.snapshotsRequest
			? SnapshotsRequest.toAmino(message.snapshotsRequest)
			: undefined
		obj.snapshots_response = message.snapshotsResponse
			? SnapshotsResponse.toAmino(message.snapshotsResponse)
			: undefined
		obj.chunk_request = message.chunkRequest
			? ChunkRequest.toAmino(message.chunkRequest)
			: undefined
		obj.chunk_response = message.chunkResponse
			? ChunkResponse.toAmino(message.chunkResponse)
			: undefined
		return obj
	},
