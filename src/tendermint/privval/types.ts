...
import { Proposal, type ProposalAmino, Vote, type VoteAmino } from "../types/types"
export enum Errors {
	ERRORS_UNKNOWN = 0,
...
export const Message = {
	...
	fromAmino(object: MessageAmino): Message {
		...
		if (
			...
			message.signedProposalResponse = SignedProposalResponse.fromAmino(
				object.signed_proposal_response
			)
		}
	...
	toAmino(message: Message): MessageAmino {
		const obj: any = {}
		obj.pub_key_request = message.pubKeyRequest
			? PubKeyRequest.toAmino(message.pubKeyRequest)
			: undefined
		obj.pub_key_response = message.pubKeyResponse
			? PubKeyResponse.toAmino(message.pubKeyResponse)
			: undefined
		obj.sign_vote_request = message.signVoteRequest
			? SignVoteRequest.toAmino(message.signVoteRequest)
			: undefined
		obj.signed_vote_response = message.signedVoteResponse
			? SignedVoteResponse.toAmino(message.signedVoteResponse)
			: undefined
		obj.sign_proposal_request = message.signProposalRequest
			? SignProposalRequest.toAmino(message.signProposalRequest)
			: undefined
		obj.signed_proposal_response = message.signedProposalResponse
			? SignedProposalResponse.toAmino(message.signedProposalResponse)
			: undefined
		obj.ping_request = message.pingRequest ? PingRequest.toAmino(message.pingRequest) : undefined
		obj.ping_response = message.pingResponse
			? PingResponse.toAmino(message.pingResponse)
			: undefined
		return obj
	},
