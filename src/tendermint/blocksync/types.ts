...
import { Block, type BlockAmino } from "../types/block"
import { ExtendedCommit, type ExtendedCommitAmino } from "../types/types"
...
/** StatusRequest requests the status of a peer. */
export type StatusRequestAmino = {}
...
export const BlockResponse = {
	...
	fromPartial(object: Partial<BlockResponse>): BlockResponse {
		...
		message.block =
			object.block !== undefined && object.block !== null
				...
				: undefined
		message.extCommit =
			object.extCommit !== undefined && object.extCommit !== null
	...
	fromAmino(object: BlockResponseAmino): BlockResponse {
		...
		if (object.ext_commit !== undefined && object.ext_commit !== null) {
			message.extCommit = ExtendedCommit.fromAmino(object.ext_commit)
		}
		return message
	},
	toAmino(message: BlockResponse): BlockResponseAmino {
		...
		obj.ext_commit = message.extCommit ? ExtendedCommit.toAmino(message.extCommit) : undefined
		return obj
	},
...
export const Message = {
	...
	toAmino(message: Message): MessageAmino {
		const obj: any = {}
		obj.block_request = message.blockRequest
			? BlockRequest.toAmino(message.blockRequest)
			: undefined
		obj.no_block_response = message.noBlockResponse
			? NoBlockResponse.toAmino(message.noBlockResponse)
			: undefined
		obj.block_response = message.blockResponse
			? BlockResponse.toAmino(message.blockResponse)
			: undefined
		obj.status_request = message.statusRequest
			? StatusRequest.toAmino(message.statusRequest)
			: undefined
		obj.status_response = message.statusResponse
			? StatusResponse.toAmino(message.statusResponse)
			: undefined
		return obj
	},
