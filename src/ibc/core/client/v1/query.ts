...
import { MerklePath, type MerklePathAmino } from "../../commitment/v1/commitment"
import {
	ConsensusStateWithHeight,
	type ConsensusStateWithHeightAmino,
	Height,
	type HeightAmino,
	IdentifiedClientState,
	type IdentifiedClientStateAmino,
	Params,
	type ParamsAmino
} from "./client"
/**
 ...
 * method.
 */
export type QueryClientParamsRequestAmino = {}
 ...
 * Query/UpgradedClientState RPC method
 */
export type QueryUpgradedClientStateRequestAmino = {}
 ...
 * Query/UpgradedConsensusState RPC method
 */
export type QueryUpgradedConsensusStateRequestAmino = {}
...
export const QueryVerifyMembershipRequest = {
	...
	toAmino(message: QueryVerifyMembershipRequest): QueryVerifyMembershipRequestAmino {
		...
		obj.block_delay =
			message.blockDelay !== BigInt(0) ? message.blockDelay?.toString() : undefined
		return obj
	},
