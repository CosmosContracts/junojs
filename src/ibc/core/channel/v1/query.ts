...
import {
	...
	type ChannelAmino,
	IdentifiedChannel,
	type IdentifiedChannelAmino,
	PacketState,
	type PacketStateAmino
} from "./channel"
import { ErrorReceipt, type ErrorReceiptAmino, Upgrade, type UpgradeAmino } from "./upgrade"
...
/** QueryChannelParamsRequest is the request type for the Query/ChannelParams RPC method. */
export type QueryChannelParamsRequestAmino = {}
...
export const QueryPacketAcknowledgementsRequest = {
	...
	fromAmino(object: QueryPacketAcknowledgementsRequestAmino): QueryPacketAcknowledgementsRequest {
		...
		message.packetCommitmentSequences =
			object.packet_commitment_sequences?.map((e) => BigInt(e)) || []
		return message
	},
	toAmino(message: QueryPacketAcknowledgementsRequest): QueryPacketAcknowledgementsRequestAmino {
		...
		if (message.packetCommitmentSequences) {
			obj.packet_commitment_sequences = message.packetCommitmentSequences.map((e) =>
				e.toString()
			)
		} else {
