 ...
 * type.
 */
export type MsgConnectionOpenInitResponseAmino = {}
...
/** MsgConnectionOpenTryResponse defines the Msg/ConnectionOpenTry response type. */
export type MsgConnectionOpenTryResponseAmino = {}
...
/** MsgConnectionOpenAckResponse defines the Msg/ConnectionOpenAck response type. */
export type MsgConnectionOpenAckResponseAmino = {}
 ...
 * response type.
 */
export type MsgConnectionOpenConfirmResponseAmino = {}
...
export const MsgConnectionOpenInit = {
	...
	toAmino(message: MsgConnectionOpenInit): MsgConnectionOpenInitAmino {
		...
		obj.delay_period =
			message.delayPeriod !== BigInt(0) ? message.delayPeriod?.toString() : undefined
