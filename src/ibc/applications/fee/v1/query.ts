...
import { PacketId, type PacketIdAmino } from "../../../core/channel/v1/channel"
import { IdentifiedPacketFees, type IdentifiedPacketFeesAmino } from "./fee"
import { FeeEnabledChannel, type FeeEnabledChannelAmino } from "./genesis"
...
export const QueryIncentivizedPacketsRequest = {
	...
	fromPartial(object: Partial<QueryIncentivizedPacketsRequest>): QueryIncentivizedPacketsRequest {
		...
		message.queryHeight =
			object.queryHeight !== undefined && object.queryHeight !== null
				? BigInt(object.queryHeight.toString())
				: BigInt(0)
		return message
	},
	...
	toAmino(message: QueryIncentivizedPacketsRequest): QueryIncentivizedPacketsRequestAmino {
		...
		obj.query_height =
			message.queryHeight !== BigInt(0) ? message.queryHeight?.toString() : undefined
		return obj
	},
...
export const QueryIncentivizedPacketsResponse = {
	...
	fromAminoMsg(
		object: QueryIncentivizedPacketsResponseAminoMsg
	): QueryIncentivizedPacketsResponse {
	...
	fromProtoMsg(
		message: QueryIncentivizedPacketsResponseProtoMsg
	): QueryIncentivizedPacketsResponse {
