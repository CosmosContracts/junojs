...
export const GenesisState = {
	...
	fromAmino(object: GenesisStateAmino): GenesisState {
		const message = createBaseGenesisState()
		message.identifiedFees =
			object.identified_fees?.map((e) => IdentifiedPacketFees.fromAmino(e)) || []
		message.feeEnabledChannels =
			object.fee_enabled_channels?.map((e) => FeeEnabledChannel.fromAmino(e)) || []
		message.registeredPayees =
			object.registered_payees?.map((e) => RegisteredPayee.fromAmino(e)) || []
		message.registeredCounterpartyPayees =
			object.registered_counterparty_payees?.map((e) =>
				RegisteredCounterpartyPayee.fromAmino(e)
			) || []
		message.forwardRelayers =
			object.forward_relayers?.map((e) => ForwardRelayerAddress.fromAmino(e)) || []
		return message
	},
