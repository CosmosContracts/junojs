...
export const MsgRegisterStaking = {
	...
	toAmino(message: MsgRegisterStaking): MsgRegisterStakingAmino {
		...
		obj.register_address = message.registerAddress === "" ? undefined : message.registerAddress
		return obj
	},
	fromAminoMsg(object: MsgRegisterStakingAminoMsg): MsgRegisterStaking {
		return MsgRegisterStaking.fromAmino(object.value)
	},
	toAminoMsg(message: MsgRegisterStaking): MsgRegisterStakingAminoMsg {
		return {
			type: "juno/x/cwhooks/MsgRegisterStaking",
			value: MsgRegisterStaking.toAmino(message)
		}
	},
...
export const MsgRegisterGovernance = {
	...
	toAminoMsg(message: MsgRegisterGovernance): MsgRegisterGovernanceAminoMsg {
		return {
			type: "juno/x/cwhooks/MsgRegisterGovernance",
			value: MsgRegisterGovernance.toAmino(message)
		}
	},
...
export const MsgRegisterGovernanceResponse = {
	typeUrl: "/juno.cwhooks.v1.MsgRegisterGovernanceResponse",
	encode(
		_: MsgRegisterGovernanceResponse,
		writer: BinaryWriter = BinaryWriter.create()
	): BinaryWriter {
		return writer
	},
...
export const MsgUnregisterGovernance = {
	...
	toAminoMsg(message: MsgUnregisterGovernance): MsgUnregisterGovernanceAminoMsg {
		return {
			type: "juno/x/cwhooks/MsgUnregisterGovernance",
			value: MsgUnregisterGovernance.toAmino(message)
		}
	},
...
export const MsgUnregisterGovernanceResponse = {
	typeUrl: "/juno.cwhooks.v1.MsgUnregisterGovernanceResponse",
	encode(
		_: MsgUnregisterGovernanceResponse,
		writer: BinaryWriter = BinaryWriter.create()
	): BinaryWriter {
		return writer
	},
...
export const MsgUnregisterStaking = {
	...
	toAminoMsg(message: MsgUnregisterStaking): MsgUnregisterStakingAminoMsg {
		return {
			type: "juno/x/cwhooks/MsgUnregisterStaking",
			value: MsgUnregisterStaking.toAmino(message)
		}
	},
...
export const MsgUnregisterStakingResponse = {
	typeUrl: "/juno.cwhooks.v1.MsgUnregisterStakingResponse",
	encode(
		_: MsgUnregisterStakingResponse,
		writer: BinaryWriter = BinaryWriter.create()
	): BinaryWriter {
		return writer
	},
