...
/** The response message for updating a fee pay contract wallet limit. */
export type MsgUpdateFeePayContractWalletLimitResponseAmino = {}
...
export const MsgRegisterFeePayContract = {
	...
	toAminoMsg(message: MsgRegisterFeePayContract): MsgRegisterFeePayContractAminoMsg {
		return {
			type: "juno/x/feepay/MsgRegisterFeePayContract",
			value: MsgRegisterFeePayContract.toAmino(message)
		}
	},
...
export const MsgRegisterFeePayContractResponse = {
	typeUrl: "/juno.feepay.v1.MsgRegisterFeePayContractResponse",
	encode(
		_: MsgRegisterFeePayContractResponse,
		writer: BinaryWriter = BinaryWriter.create()
	): BinaryWriter {
		return writer
	},
	...
	fromAminoMsg(
		object: MsgRegisterFeePayContractResponseAminoMsg
	): MsgRegisterFeePayContractResponse {
		return MsgRegisterFeePayContractResponse.fromAmino(object.value)
	},
	fromProtoMsg(
		message: MsgRegisterFeePayContractResponseProtoMsg
	): MsgRegisterFeePayContractResponse {
	...
	): MsgRegisterFeePayContractResponseProtoMsg {
		return {
			typeUrl: "/juno.feepay.v1.MsgRegisterFeePayContractResponse",
...
export const MsgUnregisterFeePayContract = {
	...
	toAminoMsg(message: MsgUnregisterFeePayContract): MsgUnregisterFeePayContractAminoMsg {
		return {
			type: "juno/x/feepay/MsgUnregisterFeePayContract",
			value: MsgUnregisterFeePayContract.toAmino(message)
		}
	},
...
export const MsgUnregisterFeePayContractResponse = {
	typeUrl: "/juno.feepay.v1.MsgUnregisterFeePayContractResponse",
	encode(
		_: MsgUnregisterFeePayContractResponse,
		writer: BinaryWriter = BinaryWriter.create()
	): BinaryWriter {
		return writer
	},
	...
	fromPartial(
		_: Partial<MsgUnregisterFeePayContractResponse>
	...
	fromAminoMsg(
		object: MsgUnregisterFeePayContractResponseAminoMsg
	): MsgUnregisterFeePayContractResponse {
		return MsgUnregisterFeePayContractResponse.fromAmino(object.value)
	},
	fromProtoMsg(
		message: MsgUnregisterFeePayContractResponseProtoMsg
	): MsgUnregisterFeePayContractResponse {
	...
	): MsgUnregisterFeePayContractResponseProtoMsg {
		return {
			typeUrl: "/juno.feepay.v1.MsgUnregisterFeePayContractResponse",
...
export const MsgFundFeePayContract = {
	...
	toAminoMsg(message: MsgFundFeePayContract): MsgFundFeePayContractAminoMsg {
		return {
			type: "juno/x/feepay/MsgFundFeePayContract",
			value: MsgFundFeePayContract.toAmino(message)
		}
	},
...
export const MsgFundFeePayContractResponse = {
	typeUrl: "/juno.feepay.v1.MsgFundFeePayContractResponse",
	encode(
		_: MsgFundFeePayContractResponse,
		writer: BinaryWriter = BinaryWriter.create()
	): BinaryWriter {
		return writer
	},
...
export const MsgUpdateFeePayContractWalletLimit = {
	...
	fromPartial(
		object: Partial<MsgUpdateFeePayContractWalletLimit>
	): MsgUpdateFeePayContractWalletLimit {
		const message = createBaseMsgUpdateFeePayContractWalletLimit()
		message.senderAddress = object.senderAddress ?? ""
		message.contractAddress = object.contractAddress ?? ""
		message.walletLimit =
			object.walletLimit !== undefined && object.walletLimit !== null
				? BigInt(object.walletLimit.toString())
				: BigInt(0)
		return message
	},
	...
	toAmino(message: MsgUpdateFeePayContractWalletLimit): MsgUpdateFeePayContractWalletLimitAmino {
		...
		obj.contract_address = message.contractAddress === "" ? undefined : message.contractAddress
		obj.wallet_limit =
			message.walletLimit !== BigInt(0) ? message.walletLimit?.toString() : undefined
		return obj
	},
	fromAminoMsg(
		object: MsgUpdateFeePayContractWalletLimitAminoMsg
	): MsgUpdateFeePayContractWalletLimit {
		return MsgUpdateFeePayContractWalletLimit.fromAmino(object.value)
	},
	toAminoMsg(
		message: MsgUpdateFeePayContractWalletLimit
	): MsgUpdateFeePayContractWalletLimitAminoMsg {
		return {
			type: "juno/x/feepay/MsgUpdateFeePayContractWalletLimit",
			value: MsgUpdateFeePayContractWalletLimit.toAmino(message)
		}
	},
	fromProtoMsg(
		message: MsgUpdateFeePayContractWalletLimitProtoMsg
	): MsgUpdateFeePayContractWalletLimit {
	...
	toProtoMsg(
		message: MsgUpdateFeePayContractWalletLimit
	): MsgUpdateFeePayContractWalletLimitProtoMsg {
		return {
			typeUrl: "/juno.feepay.v1.MsgUpdateFeePayContractWalletLimit",
...
export const MsgUpdateFeePayContractWalletLimitResponse = {
	typeUrl: "/juno.feepay.v1.MsgUpdateFeePayContractWalletLimitResponse",
	encode(
		_: MsgUpdateFeePayContractWalletLimitResponse,
		writer: BinaryWriter = BinaryWriter.create()
	): BinaryWriter {
		return writer
	},
	...
	fromPartial(
		_: Partial<MsgUpdateFeePayContractWalletLimitResponse>
	): MsgUpdateFeePayContractWalletLimitResponse {
		const message = createBaseMsgUpdateFeePayContractWalletLimitResponse()
		return message
	},
	fromAmino(
		_: MsgUpdateFeePayContractWalletLimitResponseAmino
	): MsgUpdateFeePayContractWalletLimitResponse {
		const message = createBaseMsgUpdateFeePayContractWalletLimitResponse()
		return message
	},
	toAmino(
		_: MsgUpdateFeePayContractWalletLimitResponse
	): MsgUpdateFeePayContractWalletLimitResponseAmino {
		const obj: any = {}
		return obj
	},
	fromAminoMsg(
		object: MsgUpdateFeePayContractWalletLimitResponseAminoMsg
	): MsgUpdateFeePayContractWalletLimitResponse {
		return MsgUpdateFeePayContractWalletLimitResponse.fromAmino(object.value)
	},
	fromProtoMsg(
		message: MsgUpdateFeePayContractWalletLimitResponseProtoMsg
	): MsgUpdateFeePayContractWalletLimitResponse {
	...
	): MsgUpdateFeePayContractWalletLimitResponseProtoMsg {
		return {
			typeUrl: "/juno.feepay.v1.MsgUpdateFeePayContractWalletLimitResponse",
