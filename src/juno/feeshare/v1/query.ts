...
import { FeeShare, type FeeShareAmino } from "./feeshare"
...
export const QueryFeeShareResponse = {
	...
	toAmino(message: QueryFeeShareResponse): QueryFeeShareResponseAmino {
		const obj: any = {}
		obj.feeshare = message.feeshare
			? FeeShare.toAmino(message.feeshare)
			: FeeShare.toAmino(FeeShare.fromPartial({}))
		return obj
	},
...
export const QueryWithdrawerFeeSharesResponse = {
	...
	fromPartial(
		object: Partial<QueryWithdrawerFeeSharesResponse>
	...
	fromAminoMsg(
		object: QueryWithdrawerFeeSharesResponseAminoMsg
	): QueryWithdrawerFeeSharesResponse {
		return QueryWithdrawerFeeSharesResponse.fromAmino(object.value)
	},
	fromProtoMsg(
		message: QueryWithdrawerFeeSharesResponseProtoMsg
	): QueryWithdrawerFeeSharesResponse {
