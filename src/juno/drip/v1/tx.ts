...
export const MsgDistributeTokens = {
	...
	toAminoMsg(message: MsgDistributeTokens): MsgDistributeTokensAminoMsg {
		return {
			type: "juno/x/drip/MsgDistributeTokens",
			value: MsgDistributeTokens.toAmino(message)
		}
	},
